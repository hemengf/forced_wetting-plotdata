...
ax.errorbar(viscosityset, factor_array,yerr=err,fmt='o',ls='none',mfc='none',ms=8,mew=1,ecolor='C0',capsize=2)
...
ax.set_ylabel(r'$W_{\eta_{out}}$',fontsize=24,labelpad=0)
